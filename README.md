...
개발자나 데이터 분석가의 도움 없이 직접 인사이트를 얻을 수 있습니다.  
...
### 고객 세그먼트
이렇게 수집된 UUID로 cafe24 apiㄷ와 통신하여 마케팅 동의 여부와 전화번호를 얻을 수 있습니다.
...
알림톡 발송량을 일부를 웹푸시로 발송한다.  
그중 실패한 모수를 카카오 메시지 발송한다.

웹푸시 성공만큼 원가 절감을 기대할 수 있다.

## A/B 테스트
비슷한 집단의 일부만 마케팅 집행한다.  
집행 여부에 따른 객단가, 구매전환율 등을 분석한다.

## 거시적 시장 분석
단일 쇼핑몰이 아닌 여러 쇼핑몰의 데이터를 수집하는 솔루션인만큼  
거시적인 시장 분석이 가능하다.  
